<?php
/* Create Custom Post Type : Doctor */
...
/* Create Doctor Taxonomies */
if ( ! function_exists( 'doctor_taxonomies' ) ) {
    function doctor_taxonomies()
    {
...
add_action( 'init', 'doctor_taxonomies', 0 );
