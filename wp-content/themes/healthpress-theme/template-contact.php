                                ...
                                <div id="content">
                                        ...
                                        <div class="contact-form-container">
                                            ...
                                            <form action="<?php echo site_url(); ?>/wp-admin/admin-ajax.php" id="contact-form" class="clearfix" method="post">
                                                <div class="form-cell">
                                                    <label class="display-ie8" ><?php _e( 'Họ và tên:', 'framework'); ?></label>
                                                	<input type="text" placeholder="<?php _e( 'Họ và tên', 'framework'); ?>" class="name required" name="author" title="<?php _e( '* Please provide your name', 'framework'); ?>"  /><span>*</span>
                                                </div>
                                                
                                                <div class="form-cell">
                                                     <label class="display-ie8" ><?php _e( 'Điện thoại:', 'framework'); ?></label>
                                                	<input type="text" placeholder="<?php _e( 'Điện thoại', 'framework'); ?>" class="phone" name="phone" />
                                                </div>
                                                
                                                <div class="form-cell">
                                                     <label class="display-ie8" ><?php _e( 'Email:', 'framework'); ?></label>
                                                	<input type="text" placeholder="<?php _e( 'Email', 'framework'); ?>" class="email required" name="email" title="<?php _e( '* Please enter your email address', 'framework'); ?>" /><span>*</span>
                                                </div>
                                                
                                                <div class="form-cell">
                                                     <label class="display-ie8" ><?php _e( 'Chủ đề:', 'framework'); ?></label>
                                                	<input type="text" placeholder="<?php _e( 'Chủ đề', 'framework'); ?>" class="subject" name="subject" />
                                                </div>																								
                                                
                                                <div class="form-row">
                                                     <label class="display-ie8" ><?php _e( 'Lời nhắn:', 'framework'); ?></label>
                                                	<textarea name="message" class="message required" cols="30" rows="10" placeholder="<?php _e( 'Lời nhắn', 'framework'); ?>" title="<?php _e( '* Please enter your message', 'framework'); ?>"></textarea>
                                                	...
                                                	<input type="submit" name="submit" value="<?php _e( 'Gửi email', 'framework'); ?>" class="submit readmore"/>
