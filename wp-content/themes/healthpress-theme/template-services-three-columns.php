...
/*
*	Template Name: Services Three Columns
*/ 
get_header(); 
?>                        
                        <hgroup class="page-head"> 
                                ...
                                <h5><?php //echo $page_sub_title; ?>Hãy gọi 0902.353.077 để tư vấn miễn phí ngay!</h5>
                        </hgroup>
                        ...
                        <div id="container">                        		                                
                                ...
                                <section class="service-list three-col">
                                        		...
                                        		<?php
                                                $services_count = null;//intval(get_option('theme_three_col_services_number'));
                                                $services_count = empty($services_count)?12:$services_count;
														...
														<li>
																...
																{																												
																		...
																		<figure>													
																				...
																				$featured_image = wp_get_attachment_image_src( $image_id,'three-columns-services' );																																						
