...
<!--[if (gt IE 9)|!(IE)]><!--> <html <?php language_attributes(); ?>> <!--<![endif]-->
		<head>
            ...
            <link rel="publisher" href="https://plus.google.com/+XetnghiemadnOrgHCM/posts" />
...
/* <![CDATA[ */
var google_conversion_id = 1048124144;
...
<img height="1" width="1" style="border-style:none;" alt="" src="//googleads.g.doubleclick.net/pagead/viewthroughconversion/1048124144/?value=0&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
				<script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script><script>  (adsbygoogle = window.adsbygoogle || []).push({    google_ad_client: "ca-pub-3568208598414242",    enable_page_level_ads: true  });</script>
		</head>
		<body <?php body_class(); ?>>				
...
?>
<h1 id="logo-container"><a href="<?php echo home_url(); ?>" class="logo"  title="<?php bloginfo( 'name' ); ?>">
...
?>
<h2 id="logo-container"><a href="<?php echo home_url(); ?>" class="logo"  title="<?php bloginfo( 'name' ); ?>">
                                        <img src="<?php echo $logo_path; ?>" alt="<?php  bloginfo( 'name' ); ?>">
                                        <span class="tagline"><?php bloginfo( 'description' ); ?></span>
                                    </a></h2>
<?php
...
?>
          ...
          //                               $sl_youtube = get_option('theme_youtube_link');
										...
										if($show_social == 'true')
										{
                                                ...
                                                <ul class="social-nav">
                                                        <?php
                                                                echo ($sl_faceook) ? '<li class="facebook"><a target="_blank" href="https://www.facebook.com/adn.xacdinhhuyetthong"></a></li>' : '';
