                                        ...
                                        if($theme_show_services == 'true')
										{
                                            ...
                                            <ul class="services">
                                                ...
                                                if(!empty($first_image))
                                                {
                                                    ?>
                                		          <li class="service">
                                        		      <figure class="service-thumb"><a href="<?php echo get_option('theme_first_link'); ?>"><img src="<?php echo $first_image; ?>" alt="<?php echo stripslashes(get_option('theme_first_heading')); ?>"></a></figure>
                                                      <h4><a href="<?php echo get_option('theme_first_link'); ?>"><?php echo stripslashes(get_option('theme_first_heading')); ?></a></h4>
                                                ...
                                                if(!empty($second_image))
                                                {
                                                    ?>
                                                  <li class="service">
                                        		      <figure class="service-thumb"><a href="<?php echo get_option('theme_second_link'); ?>"><img src="<?php echo $second_image; ?>" alt="<?php echo stripslashes(get_option('theme_second_heading')); ?>"></a></figure>
                                                      <h4><a href="<?php echo get_option('theme_second_link'); ?>"><?php echo stripslashes(get_option('theme_second_heading')); ?></a></h4>
                                                ...
                                                if(!empty($third_image))
                                                {
                                                    ?>
                                                  <li class="service">
                                        		      <figure class="service-thumb"><a href="<?php echo get_option('theme_third_link'); ?>"><img src="<?php echo $third_image; ?>" alt="<?php echo stripslashes(get_option('theme_third_heading')); ?>"></a></figure>
                                                      <h4><a href="<?php echo get_option('theme_third_link'); ?>"><?php echo stripslashes(get_option('theme_third_heading')); ?></a></h4>
                                                ...
                                                if(!empty($fourth_image))
                                                {
                                                    ?>
                                                  <li class="service">
                                        		      <figure class="service-thumb"><a href="<?php echo get_option('theme_fourth_link'); ?>"><img src="<?php echo $fourth_image; ?>" alt="<?php echo stripslashes(get_option('theme_fourth_heading')); ?>"></a></figure>
                                                      <h4><a href="<?php echo get_option('theme_fourth_link'); ?>"><?php echo stripslashes(get_option('theme_fourth_heading')); ?></a></h4>
                                                ...
                                                if(!empty($fifth_image))
                                                {
                                                    ?>
                                                    <li class="service">
                                                      <figure class="service-thumb"><a href="<?php echo get_option('theme_fifth_link'); ?>"><img src="<?php echo $fifth_image; ?>" alt="<?php echo stripslashes(get_option('theme_fifth_heading')); ?>"></a></figure>
                                                      <h4><a href="<?php echo get_option('theme_fifth_link'); ?>"><?php echo stripslashes(get_option('theme_fifth_heading')); ?></a></h4>
