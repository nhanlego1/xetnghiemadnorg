...
$department = $department->name;
                                                                                ...
                                                                                $show_intro_text = get_option('theme_show_intro_txt2');

                                                                                if( $show_intro_text == 'true')
                                                                                {
                                                                                    $doctor_intro_text = get_post_meta($post->ID,'doctor_intro_text',true);
																					if($doctor_intro_text==''){ echo '<p>';framework_excerpt(18);echo '</p>';}
																					else echo '<p>'. $doctor_intro_text.'</p>';
                                                                                }
                                                                                else
                                                                                {
