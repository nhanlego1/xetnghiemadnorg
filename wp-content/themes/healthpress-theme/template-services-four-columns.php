...
/*
*	Template Name: Services Four Columns
*/ 
get_header(); 
?>                        
                        ...
                        <div id="container">                        		                                
                                ...
                                <section class="service-list four-col">
                                		                                        
                                        		<?php
                                                $services_count = intval(get_option('theme_four_col_services_number'));
                                                $services_count = empty($services_count)?4:$services_count;
														...
														<li>
																...
																{																												
																		...
																		<figure>													
																				...
																				$featured_image = wp_get_attachment_image_src( $image_id,'four-columns-services' );																																						
