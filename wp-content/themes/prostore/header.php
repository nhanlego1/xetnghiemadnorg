	...
	<div class="top-bar">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						<?php if(isset($data['header_social']) && ($data['header_social'] != 0)) { ?>
							<div class="icons-social">
								<?php
									$social_links = array('facebook', 'twitter', 'googleplus', 'youtube', 'linkedin', 'flickr', 'tumblr', 'foursquare', 'apple', 'android', 'vk', 'windows', 'behance', 'dribbble', 'delicious', 'pinterest', 'instagram', 'skype', 'github', 'vimeo', 'rss');
									if($social_links) {
						...
						<div class="row">
							<div class="col-lg-12">
								<nav id="navigation">
									...
									<?php { ?> 
											<?php if(isset($data['display_search']))  { ?>
												<?php if($data['display_search'] == 1)  { ?>
													<div id="search-btn"><span></span></div>
													<div class="search-input" id="search-input" style="display:none;">
														<form role="search" method="get" class="search-form" action="<?php echo home_url( '/' ); ?>">
			                  								<input id="prostore-search-input" type="text" placeholder="Search..." name="s">
			                  							</form>
			                						</div>								
				                					<?php } else  { ?>
												<?php } ?>
