...
?>
	...
	<?php
		...
		<?php if ( has_post_thumbnail() ) { ?> 
		<?php { ?> 
			<?php if(isset($data['post_thumb_set']))  { ?>
				<?php if($data['post_thumb_set'] == 1)  { ?>
		...
		<?php } ?> 
			...
			<?php } else { ?>
				...
				<div class="post-thumbnail">
						...
						<div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-camera"></i></a></span></div>
						<?php the_post_thumbnail(); ?>
				</div>
		...
		<div class="entry-meta">
			...
			<?php } else { ?>
				...
				<ul>  
					<li><i class="icon-camera"></i> <span><?php _e('Image', 'dankov'); ?></span></li>
