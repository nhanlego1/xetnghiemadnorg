...
?>
		...
		?>
			...
			<?php } else  { ?>
					...
					<?php if( has_post_thumbnail()) { ?>
						...
						<article id="post-<?php the_ID();?>" <?php if($type_class != 'post-set $animation_class') { echo post_class("post-set $type_class $animation_class" . $first_big_post); } ?>>
					
					<?php } else  { ?>

						<article id="post-<?php the_ID(); ?>" <?php if($animation_class != 'post-set $animation_class') { echo post_class("post-set $animation_class" . $first_big_post); } ?>>
		...
		<?php } else { ?>
				...
				<div class="post-thumbnail">
						...
						<div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-link"></i></a></span></div>
		...
		<?php } ?>
			...
			<?php if(!is_single()) { ?>
				...
				<ul>  
					...
					<li><i class="icon-bubble"></i> <span><?php comments_number( '0', '1', '%' ); ?></span></li>
			...
			<?php } else { ?>
				...
				<ul>  
					<li><i class="icon-link"></i> <span><?php _e('Link', 'dankov'); ?></span></li>
