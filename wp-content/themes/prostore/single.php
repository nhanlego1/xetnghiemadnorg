		...
		<div class="row">
			...
			<?php if(isset($data['show_related_post']))  { ?>
				<?php if($data['show_related_post'] == 1)  { ?>
						...
						<div class="col-lg-12"><h3><?php _e('Related posts'); ?></h3></div>
						<?php
									...
									<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ms-12">
											<div id="rel-post" <?php post_class(); ?>>
												<div id="related-post-thumb">
											     	<div class="post-thumbnail"><div class="single-item"></div><div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-camcorder"></i></a></span></div><?php the_post_thumbnail(array(345,258)); ?></div>
