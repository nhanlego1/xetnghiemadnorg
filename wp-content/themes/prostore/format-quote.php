...
<?php
	...
	$quote_post_data = get_post_meta($post->ID,'dankov_quote_block',true);
	$quote_post_author = get_post_meta($post->ID,'dankov_quote_author',true);
	...
	<?php
		...
		<?php } else { ?>
				...
				<div class="post-thumbnail">
						...
						<div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-speech"></i></a></span></div>
		...
		<?php } ?>
			...
			<?php } else { ?>
				...
				<ul>  
					<li><i class="icon-speech"></i> <span><?php _e('Quote', 'dankov'); ?></span></li>
