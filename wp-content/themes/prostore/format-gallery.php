	...
	<?php
		...
		<?php  
			...
			<?php }
				...
				<div class="post-thumbnail">
						...
						<div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-picture"></i></a></span></div>
		...
		<div class="entry-meta">
			...
			<?php } else { ?>
				...
				<ul>  
					<li><i class="icon-picture"></i> <span><?php _e('Gallery', 'dankov'); ?></span></li>
