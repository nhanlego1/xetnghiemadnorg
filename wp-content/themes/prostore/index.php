		...
		<?php { ?> 
			...
			<div class="under-slider">
				<div class="row">
					...
					query_posts( array( 'post__in' => $sticky, 'ignore_sticky_posts' => 1 ) ); // The query
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 col-ms-12">
	<div id="sticky-post-slider" <?php post_class('big-sticky'); ?>>
	<div class="post-thumbnail"><div class="single-item"></div><div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-camcorder"></i></a></span></div><?php the_post_thumbnail(array(545,409)); ?></div>
...
<div id="sticky-post-slider" <?php post_class(); ?>>
<div class="post-thumbnail"><div class="single-item"></div><div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-camcorder"></i></a></span></div><?php the_post_thumbnail(array(325,244)); ?></div>
<div class="title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></div>
<div class="entry-meta">
				<ul>  
					<li><i class="icon-bubble"></i> <span><?php comments_number( '0', '1', '%' ); ?></span></li>
