		...
		<?php  
			...
			<?php } else { ?>
				...
				<div class="post-thumbnail">
						...
						<div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-camcorder"></i></a></span></div>
	...
	<div class="post-content">
		<?php  
			...
			<?php } else { ?>
				...
				<ul>  
					<li><i class="icon-camcorder"></i> <span><?php _e('Video', 'dankov'); ?></span></li>
