...
<?php
	global $first_big_post_counter;
	$standard_post_data = get_post_meta($post->ID,'standard_select',true);
		...
		<?php } ?> 
			...
			<?php } else { ?>
				...
				<div class="post-thumbnail">
						...
						<div class="single-action"><span><a href="<?php the_permalink(); ?>"><i class="icon-pencil"></i></a></span></div>
						<?php the_post_thumbnail(); ?>
				</div>	
