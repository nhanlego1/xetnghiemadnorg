	...
	<div class="ls-box ls-skin-editor-box">
		...
		<form action="<?php echo $_SERVER['REQUEST_URI'] ?>" method="post" class="inner">
			...
			<textarea rows="10" cols="50" name="contents"class="ls-codemirror"><?php if(!empty($contents)) {
					...
					echo '.ls-layer { /* .ls-layer refers your slides */' . NL  . NL . '}' . NL.NL;
					echo '.ls-layer a:hover {' . NL.TAB . 'color: blue;' . NL.TAB . 'text-decoration: underline;' . NL . '}' . NL.NL;
					echo '.ls-layer #yourID {' . NL  . NL . '}' . NL.NL;
					echo '.ls-layer .yourClass {' . NL  . NL . '}' . NL.NL;
