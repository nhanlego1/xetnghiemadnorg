...
//        'AddThis Trending Content Widget' => array('http://wordpress.org/extend/plugins/addthis-trending', 'Trending' ),
    ...
    */
    public function __construct ($options){
        ...
        $this->productCode = ADDTHIS_SMART_LAYER_PRODUCT_CODE;
    ...
    function addWidgetToJs(){
    	...
    	if ($smart_layer_id == "") {
    		...
    		$this->jsToAdd .= '<script type="text/javascript" src="//s7.addthis.com/js/'.$this->atversion.'/addthis_widget.js#pubid='. urlencode( $smart_layer_id ).'"></script>';
    	}
    }
