...
<?php
global $data, $is_landing_page;
?>
<?php if ( !justlanded_get_option('hide_footer_widgets', false)) : ?>
	<?php if ( is_active_sidebar('footer-widgets') && ( $is_landing_page == false || justlanded_get_option('force_footer_widgets', false) ) ) : ?>
...
<div class="row">
	<footer role="contentinfo">
		...
		<?php
		$this_menu = "";
		if (isset($data['menu_custom_footer']) && $data['menu_custom_footer'] != '') $this_menu = $data['menu_custom_footer'];
		if (is_user_logged_in() && isset($data['menu_custom_footer_logged_in']) && $data['menu_custom_footer_logged_in'] != '') $this_menu = $data['menu_custom_footer_logged_in'];
