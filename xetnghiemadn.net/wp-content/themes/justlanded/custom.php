...
/* ********************************************************************************
 * LANDING PAGE TEMPLATE: LANDING PAGE BLOCK ELEMENTS
 ******************************************************************************** */

if (isset($justlanded_custom_blocks['justlanded_payment_options']) && !function_exists('justlanded_payment_options')) {
	function justlanded_payment_options() {
		global $justlanded_custom_blocks;
		echo $justlanded_custom_blocks['justlanded_payment_options'];
	}
	add_action('justlanded_payment_options', 'justlanded_payment_options');
}
...
if (isset($justlanded_custom_blocks['justlanded_cta_buttons']) && !function_exists('justlanded_cta_buttons')) {
	function justlanded_cta_buttons() {
		global $justlanded_custom_blocks;
		echo $justlanded_custom_blocks['justlanded_cta_buttons'];
	}
	add_action('justlanded_cta_buttons', 'justlanded_cta_buttons');
}
