<?php if ($data['action_buttons_layout'] != "Single Large Button") { ?>
    ...
    <div class="buttons">
        ...
        <?php if (isset($data['action_button2_modal']) && $data['action_button2_modal'] == 1) { // if modal active { ?>
            <a href="<?php echo do_shortcode($data['action_button2_link']); ?>" class="button_try gradient action_button_2"<?php if(isset($data['action_button2_onclick']) && trim($data['action_button2_onclick']) != "") echo ' onclick="'.esc_attr(trim($data['action_button2_onclick'])).'"';?> data-reveal-id="action_button2_modal"><?php echo do_shortcode(stripslashes($data['action_button2_text'])) ?></a>
        <?php } else { // no modal active ?>
            <a href="<?php echo do_shortcode($data['action_button2_link']); ?>" class="button_try gradient action_button_2"<?php if(isset($data['action_button2_onclick']) && trim($data['action_button2_onclick']) != "") echo ' onclick="'.esc_attr(trim($data['action_button2_onclick'])).'"';?><?php if (isset($data['action_button2_target']) && $data['action_button2_target'] == "New Window") echo ' target = "_blank"'; ?>><?php echo do_shortcode(stripslashes($data['action_button2_text'])) ?></a>
        <?php } ?>
    </div>
