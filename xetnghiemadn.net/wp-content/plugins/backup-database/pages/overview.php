...
function backup_database_overview_ui(){ 
	...
	if( isset( $_GET['backup_database-task'] ) && $_GET['backup_database-task'] == 'backup' ){
		...
		if( ! empty($_GET['backup_type'] ) ){
			...
			print '<h2>Database Backup Plus</h2>';
...
?>
							...
							<a class="backup_database_button" id="create-database-backup" href="<?= admin_url(); ?>?page=backup_database_overview&backup_database-task=backup&backup_type=database_backup"> Create Database Backup </a>
					</div>
					<!-- / End of tabs -->
...
<p><center><a href="http://www.wpproking.com/pricing/"><img src="<?php echo BACKUP_DATABASE_ROOT_URL .'img/30.png' ?>">	</a></center></p>
	</div>
	<!-- /wrap -->
