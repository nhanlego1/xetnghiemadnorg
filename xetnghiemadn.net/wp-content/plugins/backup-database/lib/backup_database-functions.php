...
function backup_database_add_main_page(){
	require_once( BACKUP_DATABASE_ABSPATH . '/pages/overview.php' );
	$backup_database_main = add_menu_page( __('Database Backup','db_backup'), __('Database Backup','db_backup'), 'manage_options', 'backup_database_overview', '', BACKUP_DATABASE_ROOT_URL.'assets/img/backup.png ', 'null'); 
