 ...
 * Author: WPProKing
 * Author URI:http://www.wpproking.com 
...
class Backup_Database {
	...
	public function start(){
		...
		define( 'BACKUP_DATABASE_EMOTE_HOME', 'http://blackbirdi.com');
...
function admin_notice() {
		...
		echo '<div class="updated notice-info my-wp-backup-notice" id="mywpb-notice" style="position:relative;">';
				printf(__('<p>Liked Backup Database? You will definitely love the ​<strong>Pro</strong> version. <a href="http://wpproking.com/pricing" target="_blank" class="notice-button"><strong>Get it now</strong>!</a></p>' ), '?mwpb_notice_close=1');
				echo "</div>";
