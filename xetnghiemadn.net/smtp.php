...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="Tư Vấn Xét Nghiệm ADN")
{
      ...
      $smtp_host ='ns4003.websitewelcome.com';//Dia chi mail server
      $admin_email = 'info@xetnghiemadn.net';//User duoc khai bao tren mail server
      $smtp_username = 'info@xetnghiemadn.net';//User duoc khai bao tren mail server
      $smtp_password = '123!@#';//Pass cua email nay
...
//SendMail("info@infotechvina.com","billy@infotechvina.com","Details of Booking Form","Content Testing");
